...
export function RestaurantHeroCard({
  ...
  return (
    ...
    >
      <div className={`relative overflow-hidden ${compact ? "h-[146px] sm:h-[160px] lg:h-[168px]" : "h-[156px] sm:h-[172px] lg:h-[186px]"}`}>
        {imageUrl ? (
          <Image
            src={imageUrl}
            alt={name}
      ...
      <div className={compact ? "space-y-0.5 p-2" : "space-y-1 p-2.5 sm:p-3"}>
